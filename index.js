  ...
  constructor (apiKey, apiSecret, opts = {version: 1, transform: false}) {
    ...
    if (opts.version === 2) {
      ...
      this.ws = new WS2(this.apiKey, this.apiSecret, {
        ...
        nonceGenerator: opts.nonceGenerator // Ekliptor> pass on nonce generator
      })
      opts.autoOpen && this.ws.open()
      return
    }

    this.rest = new REST(this.apiKey, this.apiSecret, opts.nonceGenerator) // Ekliptor> pass on nonce generator
